                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <select name="role" class="form-control">
                                    ...
                                    <option value="gurupiket" {{ $akun->role === 'gurupiket' ? 'selected' : '' }}>Guru Piket
                                    </option>
                                    <option value="gurubk" {{ $akun->role === 'gurubk' ? 'selected' : '' }}>Guru Bk
                                    </option>
                                    <option value="walikelas" {{ $akun->role === 'walikelas' ? 'selected' : '' }}>Wali Kelas
                                    </option>
                                </select>
                            </div>
